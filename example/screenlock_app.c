...
static void onAppLoading(void) { printf("\t[Screenlock] on app loading...\n"); }
...
static void onAppStart(void) { printf("\t press 'X' to unlock device\n"); }

static void onAppPause(void) { printf("\t[Screenlock] on app pause...\n"); }
...
static void onAppStop(void) { printf("\t[Screenlock] on app stop...\n"); }

static void stub(void) { printf("\t[Screenlock] stub called\n"); }
